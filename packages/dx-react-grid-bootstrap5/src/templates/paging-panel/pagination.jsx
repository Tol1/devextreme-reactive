...
export const Pagination = ({
  ...
  return (
    <React.Fragment>
      <PaginationBS4 className="float-end d-none d-sm-flex" listClassName="m-0">
      ...
      <PaginationBS4 className="float-end d-sm-none" listClassName="m-0">
        <PaginationItem disabled={currentPage === 0}>
          <PaginationLink
            previous
            href="#"
      ...
      <span className="float-end d-sm-none me-4">
